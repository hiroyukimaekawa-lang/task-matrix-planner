...
export function calculateUrgency(dueDate: string, importance: number): number {
  ...
  // 重要度による微調整：重要度が高い(4以上)なら緊急度を+1、低い(1)なら緊急度を-1
